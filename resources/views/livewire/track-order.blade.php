                        ...
                        <div class="mt-8">
                            ...
                            <div class="mt-4" aria-hidden="true">
                                ...
                                <div class="mt-6 hidden grid-cols-4 text-sm font-medium text-gray-600 sm:grid">
                                    ...
                                    <div class="text-center {{ $progress >= 40 ? 'text-indigo-600' : '' }}">{{ __('frontend.track.status.processing') }}</div>
                                    <div class="text-center {{ $progress >= 70 ? 'text-indigo-600' : '' }}">{{ __('frontend.track.status.shipped') }}</div>
                                    <div class="text-right {{ $progress >= 100 ? 'text-indigo-600' : '' }}">{{ __('frontend.track.status.delivered') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
